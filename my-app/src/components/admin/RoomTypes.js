                                ...
                                <div className="my-3 ">
                                    <div className="row">
                                        <div className="col-12 col-md-4 col-lg-6 mb-3">
						                    <Link to={"/roomtype/add"} className="btn btn-sm btn-success btn-add">{<i className="fa-solid fa-plus me-2"></i>}เพิ่มประเภทห้องรักษา</Link>
                                        </div>
                                ...
                                <div className="mt-2">
                                    <Table size="sm" responsive bordered hover className='text-center'>
                                        <thead>
                                            ...
                                            <tbody>
                                                {
                                                    room_type.slice(currentPage * numPerPage, (currentPage * numPerPage) + numPerPage).map(item => (
                                                        <RoomTypesItem
